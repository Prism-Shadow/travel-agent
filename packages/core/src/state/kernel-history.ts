 ...
 */
export const KERNEL_VERSION = "2026-08-31";
 ...
 * - `"2026-08-19"` — the prompt states the dual-backend product contract: IAB is the
 *   Desktop default and the user's Chrome is an explicit per-conversation alternative.
 * - `"2026-08-31"` (current) — the product Agent's per-Task turn budget defaults to 200.
 *
...
export const KERNEL_HASH_HISTORY: Readonly<Record<string, Readonly<Record<string, string>>>> = {
  ...
  // The product Agent gets a finite per-Task containment budget. Every other leaf is unchanged
  // from 2026-08-19.
  "2026-08-31": {
    system_prompt: "852c602f80efaf0050bf7883e1af844a3e6dc95588b60449447ec299e25f5237",
    max_turns: "27badc983df1780b60c2b3fa9d3a19a00e46aac798451f0febdca52920faaddf",
    "model.max_tokens": "492f431bae35265f2e5f4ed49bd8c58dda912431be561504846988d00d05d117",
    "model.thinking_level": "60d4c90eee5e731df8d3ef2891de541d2e755ff8ee9db358e26bdec49f6e0db9",
    "model.timeoutMs": "4f9f73b34c5b89879aad65a48025f3187dd9ce6dc3d4e88eecb2fc79227350f1",
    "compaction.max_context_length":
