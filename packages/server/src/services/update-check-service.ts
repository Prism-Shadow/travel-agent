...
/**
 * Repository the released artifacts come from. release.yml cuts them there. The check is
 * fail-soft: until a Release is published the endpoint answers 404 and nothing is reported.
 */
