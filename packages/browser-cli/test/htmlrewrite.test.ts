...
import { formatHtmlForPrompt } from '../src/page/htmlrewrite.js'

test('formatHtmlForPrompt', async () => {
  const assetUrl = new URL('../src/assets/framer.html', import.meta.url)
...
test('processes x.com.html with size savings', async () => {
  const html = fs.readFileSync(new URL('../src/assets/x.com.html', import.meta.url), 'utf-8')
