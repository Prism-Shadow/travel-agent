...
const DEFAULT_MAX_STRING_LENGTH = Number(process.env.PENGUIN_BROWSER_CDP_LOG_MAX_STRING_LENGTH || 2000)
...
export function createCdpLogger({
  ...
  const envMaxEntries = Number(process.env.PENGUIN_BROWSER_CDP_LOG_MAX_ENTRIES)
  ...
  // calls per second. See: https://private-project.invalid/repository/issues/96
