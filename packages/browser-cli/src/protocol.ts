...
export type StartRecordingResult =
  | {
      ...
      tabId: number
      startedAt: number
      /** Container selected by MediaRecorder. Optional for older extensions. */
      mimeType?: string
      /** Effective output path selected by the relay from mimeType. */
      outputPath?: string
    }
  | {
      success: false
...
export type StopRecordingResult =
  | {
      ...
      path: string
      size: number
      /** Container written to path. Optional for older extensions. */
      mimeType?: string
    }
  | {
      success: false
...
export type IsRecordingResult = {
  ...
  tabId?: number
  startedAt?: number
  /** Whether isRecording came from a successful extension response. */
